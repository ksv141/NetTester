...
{
    ostProtoId_ = OstProto::Protocol::kNetTestFieldNumber;
...
PdmlProtocol *PdmlNetTestProtocol::createInstance()
{
    return new PdmlNetTestProtocol();
}
...
*/
void PdmlNetTestProtocol::preProtocolHandler(QString /*name*/,
...
*/
void PdmlNetTestProtocol::prematureEndHandler(int /*pos*/,
...
*/
void PdmlNetTestProtocol::postProtocolHandler(OstProto::Protocol* /*pbProto*/,
        OstProto::Stream* /*stream*/)
{
    return;
}
...
*/
void PdmlNetTestProtocol::unknownFieldHandler(QString /*name*/,
